	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$("#update").on("click" , function() {
				alert("공지사항을 수정합니다.");
				$("form").attr("method" , "POST").attr("action" , "/campBusiness/updateCampNotice").submit();
			});
	...
	<div class="container">
		...
		<div class="form-group">
			<label for="noticeContent" class="col-sm-offset-1 col-sm-3 control-label">내용</label>
				<div class="col-sm-4">
					<input type="text" class="form-control" id="noticeContent" name="noticeContent" value="${notice.noticeContent}">
				</div>
		</div>
