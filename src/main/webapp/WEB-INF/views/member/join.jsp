...
<head>
    ...
    <title>회원가입</title>
    <link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/WEB-INF/resources/css/join.css">
    <script src="<%= request.getContextPath() %>/WEB-INF/resources/js/join.js"></script>
</head>
<body>
    <h2>회원가입</h2>
