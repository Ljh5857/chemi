                                 ...
                                 <section class="panel">
                                    <div class="panel-body">
                                       <div class="mypage-search-container">
                                          <div style="font-weight: 500; font-size:28px; margin-bottom: 30px;">내가 쓴 게시물</div>
                                                ...
                                                <div>
                                                  <select class="form-control" name="searchCondition"
                                                     ...
                                                     <option value="1" ${! empty search.searchCondition &&
                                                        search.searchCondition==1 ? "selected" : "" }>제목
                                                     </option>
                                                  </select>
                                               </div>
                                               <div>
                                                  <div class="search-box">
                                                     <input class="form-control" type="text" name="searchKeyword"
                                                        placeholder="Search..." value="${search.searchKeyword}"
                                                        style="background: ghostwhite; color: #2d2d2d;">
